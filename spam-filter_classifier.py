...
#Enron data combined with Spam assasin dataset has been obtained from : https://www.cs.bgu.ac.il/~elhadad/nlp16/spam_classifier.html 
#used their code to process the data into Pandas dataframe
#We will extract and load the Enron spam data in Pandas Dataframe.
